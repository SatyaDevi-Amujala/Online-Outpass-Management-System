...
<!--===============================================================================================-->
<?php
  $query="SELECT * FROM `perpermissions_details` WHERE `status`='ACCEPTED' and `rollnumber`='$stu_id_no' and month(`leavingdatetime`)=month(curdate())";
  ...
  if ($count < 5 ) {
    echo "<p class='limit'> Remaining Limit : ".  4-$count ." / 4 </p>";
  }else{
    echo "<p class='limit'> Your limit exceeded </p>";
  }
?>
<section >
    ...
    <div class="modal-dialog ">
      <div class="modal-content">
        ...
        <div class="modal-body">
              ...
              <div class="input-group">
                ...
                <span class="glyphicon glyphicon-user"></span>
						...
						<select id="cars"  name="prmissiontype" class="form-control rounded-pill" required>
							...
							<option value="Outing Permission">Outing Permission</option>
							<option value="Outpass Permission">Outpass Permission</option>
						</select>
              </div>
			</div>
			<div class="form-group">
          ...
          <textarea rows="3" cols="16" name="reason" class="form-control"  placeholder="Reason of Leaving" required></textarea>
			  ...
			  <div class="form-group">
				<div class="input-group">
				  ...
				  <input  type="tel"  name="contacnumber" class="form-control rounded-pill"  placeholder="Parent Contact Number" required />
				</div>
			  </div>
