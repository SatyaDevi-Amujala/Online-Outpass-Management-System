          ...
          <form action="studentregistrationdata.php" role="form" method="POST">
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input type="text" name="rollnumber" class="form-control rounded-pill" placeholder="ID Number" required/>
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input type="text" name="student_phonenumber" class="form-control rounded-pill" placeholder="Student Phone Number" required/>
