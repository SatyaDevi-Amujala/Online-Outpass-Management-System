	...
	<table class="table table-striped table-bordered">
		<thead>
		  ...
		  <tbody id="myTable">
			  ...
			  //===================================================================================================
				$query="select * from `perpermissions_details` JOIN `student_details` ON `perpermissions_details`.`rollnumber`=`student_details`.`rollnumber` WHERE `perpermissions_details`.`status`='ACCEPTED' ORDER BY `perpermissions_details`.`sno` DESC";
