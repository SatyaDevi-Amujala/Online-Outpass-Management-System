	...
	<table class="table table-striped table-bordered">
		<thead >
		  ...
		  <tbody id="myTable">
			  ...
			  //===================================================================================================
				$query="select * from `perpermissions_details` JOIN `student_details` ON `perpermissions_details`.`rollnumber`=`student_details`.`rollnumber` WHERE `perpermissions_details`.`status`='PENDING' ORDER BY `perpermissions_details`.`sno` DESC";
			  ...
			  while($row = mysqli_fetch_array($sql))
			  {
					echo "<tr  scope='row'>
						...
						<td><a class='btn btn-success' href='formview.php?q=".$row['sno']."'>View Request</a></td>
					 </tr>";
			  }
			 ?>
