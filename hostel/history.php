	...
	<table class="table table-striped table-bordered">
        ...
        if(isset($_SESSION['student'])){
          $stu_id_no = $_SESSION['student'];
			  ...
			  //===================================================================================================
				$query="SELECT * FROM `perpermissions_details` where `rollnumber`='$stu_id_no' order by sno desc";
				$sql=mysqli_query($connect,$query);
			  //===================================================================================================
			  while($row = mysqli_fetch_array($sql))
			  {
					echo "<tr  scope='row'>
						<td>".$row['sno']."</td><td>".$stu_id_no."</td><td>".$row['reason']."</td><td>".$row['leavingdatetime']."</td>
